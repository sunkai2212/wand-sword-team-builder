...
用户反馈骑士手动更新后的技能图标整体不够居中，视觉偏右下，且技能圆在最终圆框内偏小，有多余黑边。要求参考七转技能，让技能圆尽量贴近边框。

## 结论

- 骑士 1–6 转与斗士 1 转共用技能图标的源图保持不变。
- 正式裁剪从整张 `260×260` 改为统一紧裁剪：
  - `left: 26`
  - `top: 26`
  - `width: 208`
  - `height: 208`
- 七转技能不参与本次调整。
- 缓存版本更新为 `2026-07-28-knight-manual-tight-crop`。
...
- 骑士 1–6 转手动图标必须使用 `26,26,208×208` 裁剪。
